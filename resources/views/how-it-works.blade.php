          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <ol class="breadcrumb text-center text-black text-bold mt-10">
                <li><a href="/">Home</a></li>
                <li class="active text-theme-colored">How It Works</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <p><h3>How <span class="text-theme-colored font-weight-400">2MA</span> Works</h3>
              ...
              <a class="btn btn-lg btn-dark btn-theme-colored mt-20 mb-sm-20" href="/pricing"><i class="fa fa-link"></i> See Pricing</a>
            </div>
