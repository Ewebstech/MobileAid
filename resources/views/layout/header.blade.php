        ...
        <div class="row">
          <div class="col-md-4">
            <div class="widget no-border m-0">
              <ul class="styled-icons icon-dark icon-circled icon-theme-colored icon-sm flip sm-pull-none sm-text-center mt-sm-10">
          ...
          <div class="col-md-8">
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right sm-text-center mt-5">
                <li>
        ...
        <div class="container">
          <nav id="menuzord" class="menuzord default bg-theme-colored">
            ...
            <ul class="list-inline pull-right flip hidden-sm hidden-xs">
              <li>
                <a class="btn btn-flat text-white border-2px  font-13" href="/login" style="margin-top: 13px;"> <i class="fa fa-sign-in"></i> Login</a>
              </li>
            </ul>
             <ul class="list-inline pull-right flip hidden-sm hidden-xs">
              <li>
