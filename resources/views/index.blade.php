            ...
            <div class="col-md-6">
              ...
              <h4 class="font-18 font-weight-500 text-gray-dimgray mt-20 mb-15"> <i>"2MA is designed to help people get medical help over the phones to treat, control or manage
                ...
                people do not know what to do they can call for medical advice or assistance.
                            ...
                            <p class="text-black">   
                        It is particularly very useful in heart attacks, strokes, seizures, accidents, feeling dizzy and light
                        headed, or when there is constant pain or sudden skin reaction. The critical information on what to
      ...
      <div class="container pb-30 pb-sm-60">
        <div class="section-content">
          <div class="row mtli-row-clearfix">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="icon-box p-10 mb-30">
                    <div class="media-left">
                      <a class="icon icon-md icon-color flip mb-0 mr-0 mt-5" href="#">
                        <i class="flaticon-medical-xray2 text-theme-colored"></i>
                      </a>
                      </div>
                    <div class="icon-box-details media-body">
                      <h5 class="icon-box-title m-0 mb-5 text-bold">Urgent Health Issues </h5>
                      <p class="mb-0 text-black">We profer mobile aid solutions to urgent health issues of the forms; Sudden collapse or loss of consciousness, Seizures, Fever with chills and rigors, Vomiting, Stomach ache, Migraine, Sickle cell crises, Burns</p>
                    </div>
                  </div>    
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
            ...
            <div class="col-md-4">
              <div class="border-5px border-theme-colored p-30 mt-70">
                <h5 class="mt-0"><i class="fa fa-clock-o text-theme-colored"></i> Service Consultation Hours</h5>
                <div class="opening-hours open-hours-new text-left">
                  <ul class="list-unstyled">
                    <li class="clearfix line-height-1"> <span> Sundays </span>
                      <div class="value"> 12.00AM - 11:59PM </div>
                    </li>
                    <li class="clearfix line-height-1"> <span> Monday </span>
                    <div class="value"> 12.00AM - 11:59PM </div>
                    </li>
                    <li class="clearfix line-height-1"> <span> Tuesday </span>
                    <div class="value"> 12.00AM - 11:59PM </div>
                    </li>
                    <li class="clearfix line-height-1"> <span> Wednesday </span>
                    <div class="value"> 12.00AM - 11:59PM </div>
                    </li>
                    <li class="clearfix line-height-1"> <span> Thurs - Friday </span>
                    <div class="value"> 12.00AM - 11:59PM </div>
                    </li>
                ...
                <h5 class="mt-30"><i class="fa fa-pencil-square-o text-theme-colored"></i> Need Medical Help?</h5>
                <p class="mt-0">Subscribe With Us Today</p>
                <center>
                    <a href="/signup" class="btn btn-dark btn-theme-colored mt-15"> <i class="fa fa-user"></i> Quick Signup</a>
                </center>
